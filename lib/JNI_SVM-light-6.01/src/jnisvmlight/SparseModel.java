 ...
 */
public class SparseModel implements Serializable {

  /**
   * Reads an SVM-light model from a URL and creates an SparseModel object in
   * Java. The format is compatible to the SVM-light model files.
   */
  public static SparseModel readSparseModelFromURL(URL file)
    ...
    SparseModel model = new SparseModel(format, kType, dParam, gParam,
  ...
  protected SparseModel(String format, long ktype, long dparm, double gparm,
  ...
  /**
   * Writes this SparseModel to a file. The format is compatible to the
