...
<!-- ToDo: untokenized text: not possible in folia -->
...
<FoLiA xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://ilk.uvt.nl/folia" 
  ...
  <metadata  type="imdi">
    <annotations> <!-- dit kan je allemaal niet weten, niet uit TEI metadata te halen -->
      <xsl:if test="//w"> <token-annotation annotator="unknown" annotatortype="auto"/></xsl:if>
      <xsl:if test="//w/@type"><pos-annotation annotator="unknown" annotatortype="auto" set="unknown"/></xsl:if>
      <xsl:if test="//w/@lemma">
      <lemma-annotation annotator="unknown" annotatortype="auto" set="unknown"/></xsl:if>
      <xsl:if test="//name"><entity-annotation annotator="unknown" annotatortype="auto" set="unknown"/></xsl:if>
    </annotations>
  </metadata>
  <text>
    <xsl:call-template name="setId"/>
