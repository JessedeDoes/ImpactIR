...
import tagger.Corpus;
import util.SimpleTokenizer;
import util.Database.MapFetcher;
import util.SimpleTokenizer.Token;

public class QuotationCorpus implements tagger.Corpus, Iterable<Context>, Iterator<Context> 
{
	/**
	 * 
	 */
