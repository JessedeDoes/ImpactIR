...
public class TEITokenizer extends DefaultHandler
{
	...
	public void	characters(char[] ch, int start, int length) 
	{
		...
		{
			s = nl.namescape.util.Util.escapeCharacterData(s);
			output(s);
			return;
		}
	...
	public  void startElement(String uri, String localName, String qName, Attributes attributes) 
	{
		...
		if (qName.equals("text") || qName.equals("osisText") || qName.equals("entry"))
		{
	...
	public void printStartTag(Element e)
	{
		try 
		{
			...
			for (int i=0; i < attributes.getLength(); i++)
			{
				...
				out.write(" " + n.getNodeName() + "=\"" + nl.namescape.util.Util.escapeForAttribute(n.getNodeValue()) + "\"");
			}
			out.write(">");
