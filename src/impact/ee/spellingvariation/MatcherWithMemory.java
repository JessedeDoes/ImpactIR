...
import impact.ee.util.ShortestPath;
import impact.ee.util.ShortestPath.BasicState;
import impact.ee.util.ShortestPath.MatchState;
...
public class MatcherWithMemory<State> extends MemorylessMatcher
{
	...
	static class SearchState extends impact.ee.util.ShortestPath.BasicState
	{
		int position;
