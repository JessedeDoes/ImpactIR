...
/**
 * A very simple attempt to arrive at a "reasonable" set of Frisian patterns.
 * <p>
 ...
 * </pre>
 */
public class FrisianMultigramPruner implements MultigramPruner
{
  ...
  public String[] extraGraphemes =
  {
    ...
    "bh", "dh", "jh", "kh", "lh", "mh", "qh", "rh", "sh", "th", "" +
     "vh", "wh", "zh", "ng", "nk", "nck", "sch", "dt", "sj", "tsj", "je"
  };
